...
class UserInfo(AbstractUser):
    ...
    avatar = models.FileField(upload_to="madia/avatars/", default="media/avatars/default.png", verbose_name="头像")
...
class Blog(models.Model):
    ...
    theme = models.CharField(max_length=32, verbose_name="博客主题样式")  # 博客主题样式
...
class Comment(models.Model):
    ...
    create_time = models.DateTimeField(auto_now_add=True)
    parent_comment = models.ForeignKey("self", null=True, blank=True)  # blank=True 在Django 的 admin中也可以为空
